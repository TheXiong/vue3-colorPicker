...
const STORAGE_KEY = 'x-color-picker-recent-colors';
...
.ik-color-picker {
  ...
  &__panel {
    font-size: 14px;
    z-index: 1000;
    background: var(--x-cp-bg-panel);
    /* Dark mode panel bg */
    box-shadow:
      0 3px 14px 2px var(--x-cp-shadow-color-base),
      0 8px 10px 1px var(--x-cp-shadow-color-light),
      0 5px 5px -3px var(--x-cp-shadow-color-dark);
    border-radius: 3px;
    padding: 10px;
    width: 280px;
  ...
  &__tabs {
    display: flex;
    margin-bottom: 12px;
    border-bottom: 1px solid var(--x-cp-border-color);
    padding: 4px;
    background: var(--x-cp-bg-tab-divider);
    /* Dark mode divider */
    ...
    .tab-item {
      ...
      color: var(--x-cp-text-secondary);
      background: var(--x-cp-bg-tab);

      &.active {
        color: var(--x-cp-primary-text);
        /* Active color */
        font-weight: 500;
        background: var(--x-cp-bg-tab-active);
        /* Active bg */
      }
  ...
  &__gradient-tools {
    ...
    .gradient-angle-slider-wrapper {
      ...
      .gradient-angle-slider {
        flex: 1;
        height: 4px;
        background: var(--x-cp-border-color);
        border-radius: 2px;
        position: relative;
        cursor: pointer;
        ...
        .slider-thumb {
          ...
          width: 8px;
          height: 8px;
          background: var(--x-cp-text-inverse);
          border-radius: 50%;
        ...
        &:hover {
          background: var(--x-cp-border-color-dark);
        }
      }
    }
    ...
    .gradient-bar {
      ...
      position: relative;
      cursor: pointer;
      box-shadow: inset 0 0 2px var(--x-cp-shadow-color-heavy);
      background-image: var(--x-cp-bg-checkerboard);
  ...
  &__saturation {
    ...
    &--white {
      background: var(--x-cp-gradient-white);
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
    ...
    &--black {
      background: var(--x-cp-gradient-black);
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
    ...
    &--cursor {
      ...
      width: 12px;
      height: 12px;
      border: 1px solid var(--x-cp-text-inverse);
      border-radius: 50%;
      box-shadow: 0 0 2px var(--x-cp-shadow-color-heavy);
      transform: translate(-50%, -50%);
      pointer-events: none;
  ...
  &__slider {
    ...
    .slider-thumb {
      ...
      background: var(--x-cp-text-inverse);
      border-radius: 50%;
      box-shadow: 0 0 2px var(--x-cp-shadow-color-deep);
      transform: translate(-50%, -50%);
      pointer-events: none;
    }

    &.hue-slider {
      background: var(--x-cp-gradient-hue);
    }
  ...
  &__swatches {
    ...
    .swatch-item {
      ...
      &:hover {
        transform: scale(1.1);
        z-index: 1;
        box-shadow: 0 0 4px var(--x-cp-shadow-color-heavy);
      }
    }
  }
}
